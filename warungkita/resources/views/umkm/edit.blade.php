<x-app-layout>
    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        <h4 class="mt-4 text-white text-2xl text-center font-bold">Edit Data UMKM</h4>
        <div class="container mx-auto">
            <form method="post" class="shadow-md rounded px-8 pt-6 pb-8 mb-4"
                action="{{ route('umkm.update', $umkm->id) }}">
                @csrf
                <div class="mb-4">
                    ...
                    <input
                        ...
                        name="nama" type="text" placeholder="Masukkan Nama UMKM" value="{{ $umkm->nama }}">
                </div>
                <div class="mb-4">
                    ...
                    <input
                        class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                        name="modal" type="text" placeholder="Masukkan Modal UMKM" value="{{ $umkm->modal }}">
                </div>
                <div class="mb-4">
                ...
                <div class="mb-4">
                    ...
                    <input
                        class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                        name="alamat" type="longtext" placeholder="Masukkan Alamat UMKM" value="{{ $umkm->alamat }}">
                </div>
                <div class="mb-4">
                ...
                <div class="mb-4">
                    ...
                    <input
                        class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                        name="email" type="text" placeholder="Masukkan Email" value="{{ $umkm->email }}">
                </div>
                <div class="mb-4">
                ...
                <div class="mb-4">
                    ...
                    <input
                        class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                        name="pembina_id" type="number" placeholder="Masukkan Id Pembina"
                        value="{{ $umkm->pembina_id }}">
                </div>
