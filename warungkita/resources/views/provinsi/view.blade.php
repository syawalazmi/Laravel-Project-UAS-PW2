            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                <div>
                    <a class="bg-blue-500 text-white hover:text-gray-400 font-bold py-2 px-4"
                        href="{{ route('provinsi.create') }}">Tambah
                        Data</a>
                </div>
                ...
                <table class="text-white text-center text-xs border-collapse border border-gray-300 w-full mt-6"
                    ...
                    <thead>
                        <tr>
                            ...
                            <th class="border border-gray-300 px-4 py-2">Nama Provinsi</th>
                            <th class="border border-gray-300 px-4 py-2">Ibukota</th>
                    ...
                    <tbody>
                        @foreach ($provinsi as $viewProvinsi)
                            <tr>
                                <td class="border border-gray-300 px-4 py-2">{{ $loop->iteration }}</td>
                                <td class="border border-gray-300 px-4 py-2"><?= $viewProvinsi->nama ?></td>
                                <td class="border border-gray-300 px-4 py-2"><?= $viewProvinsi->ibukota ?></td>
                                <td class="border border-gray-300 px-4 py-2"><?= $viewProvinsi->latitude ?></td>
                                <td class="border border-gray-300 px-4 py-2"><?= $viewProvinsi->longitude ?></td>
                                <td class="border border-gray-300 px-4 py-2"><a
                                        href="{{ route('provinsi.edit', $viewProvinsi->id) }}"
                                        class="text-white hover:text-gray-400 font-bold py-2 px-4 rounded">
                                        Edit
                                    </a>
                                <td class="border border-gray-300 px-4 py-2">
                                    <form action="{{ route('provinsi.delete', $viewProvinsi->id) }}" method="post">
                                        @csrf
                                        <button
