<x-app-layout>
    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        <h3 class="mt-6 text-white text-2xl text-center font-bold">Tambah Data Provinsi</h3>
        <div class="container mx-auto">
            <form method="post" class="shadow-md rounded px-8 pt-6 pb-8 mb-4" action="{{ route('provinsi.submit') }}">
                @csrf
                <div class="mb-4">
                    ...
                    <input
                        ...
                        name="nama" type="text" placeholder="Masukkan Nama Provinsi">
                </div>
                <div class="mb-4">
                    ...
                    <input
                        class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                        name="ibukota" type="text" placeholder="Masukkan Nama Ibukota">
                </div>
                <div class="mb-4">
