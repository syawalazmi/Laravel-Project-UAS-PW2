<x-app-layout>
    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        <h4 class="mt-4 text-white text-2xl text-center font-bold">Edit Data Kabupaten/Kota</h4>
        <div class="container mx-auto">
            <form method="post" class="shadow-md rounded px-8 pt-6 pb-8 mb-4"
                action="{{ route('kab_kota.update', $kab_kota->id) }}">
                @csrf
                <div class="mb-4">
