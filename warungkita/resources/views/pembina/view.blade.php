            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                <div>
                    <a class="bg-blue-500 text-white hover:text-gray-400 font-bold py-2 px-4"
                        href="{{ route('pembina.create') }}">Tambah
                        Data</a>
                </div>
                ...
                <table class="text-white text-center text-xs border-collapse border border-gray-300 w-full mt-6"
                    ...
                    <tbody>
                        @foreach ($pembina as $viewPembina)
                            <tr>
                                <td class="border border-gray-300 px-4 py-2">{{ $loop->iteration }}</td>
                                <td class="border border-gray-300 px-4 py-2"><?= $viewPembina->nama ?></td>
                                <td class="border border-gray-300 px-4 py-2"><?= $viewPembina->gender ?></td>
                                <td class="border border-gray-300 px-4 py-2"><?= $viewPembina->tgl_lahir ?></td>
                                <td class="border border-gray-300 px-4 py-2"><?= $viewPembina->tmp_lahir ?></td>
                                <td class="border border-gray-300 px-4 py-2"><?= $viewPembina->keahlian ?></td>
                                <td class="border border-gray-300 px-4 py-2">
                                    <a href="{{ route('pembina.edit', $viewPembina->id) }}"
                                        class="text-white hover:text-gray-400 hov font-bold py-2 px-4 rounded">
                                        Edit
                                    </a>
                                <td class="border border-gray-300 px-4 py-2">
                                    <form action="{{ route('pembina.delete', $viewPembina->id) }}" method="post">
                                        @csrf
                                        <button
